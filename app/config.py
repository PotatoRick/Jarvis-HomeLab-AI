...
class Settings(BaseSettings):
    ...
    claude_model: str = "claude-haiku-4-5-20251001"  # Upgraded from Haiku 3.5 for better reasoning
    claude_max_tokens: int = 4000
    claude_timeout: int = 60

    # Model routing for complex scenarios (crash loops, health issues)
    crash_loop_model: str = "claude-sonnet-4-5-20250929"  # Use Sonnet for complex multi-step reasoning
    ...
    def validate_jarvis_external_url(cls, v: Optional[str]) -> Optional[str]:
        ...
        """
        # Treat None and empty strings as "not configured"
